...
const utils = {
  ...
  // TODO: add proper comment..
  gasFeeToCost: function(gasFeeWei, ethPrice) {
    gasFeeWei = new BigNumber(gasFeeWei);
    return gasFeeWei.dividedBy(1e18).multipliedBy(ethPrice);
  },

  pretifyCost: function(value) {
    if (value.isGreaterThan(0.1)) {
   ...
   * @return {String}      id
   */
  getMethodID: function(contractName, txData) {
    return contractName + "_" + txData.slice(2, 10);
  },
